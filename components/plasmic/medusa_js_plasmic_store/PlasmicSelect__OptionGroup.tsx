...
import sty from "./PlasmicSelect__OptionGroup.module.css"; // plasmic-import: ELtuOud_UEaz/css

import SUPER__PlasmicSelect from "./PlasmicSelect"; // plasmic-import: IGotvDsrozg7/render
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <React.Fragment>
              <Select__Option
                className={classNames("__wab_instance", sty.option__eaUf)}
              />

              <Select__Option
                className={classNames("__wab_instance", sty.option__jS1Mu)}
              />
            </React.Fragment>
          ),
          value: args.children
