...
import sty from "./PlasmicCartItem.module.css"; // plasmic-import: aMM1xOjQ0G0x/css

import RecycleIcon from "./icons/PlasmicIcon__Recycle"; // plasmic-import: 77aXUyq1U2Pp/icon
  ...
  return (
    ...
    >
      ...
      <Stack__
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__bmYyo)}
      >
        <PlasmicLink__
          ...
          platform={"nextjs"}
        >
          <div className={classNames(projectcss.all, sty.freeBox__sgCy0)}>
            <div
              className={classNames(
                projectcss.all,
        ...
        {(_par => (!_par ? [] : Array.isArray(_par) ? _par : [_par]))(
          ...
          return (
            <div
              className={classNames(projectcss.all, sty.freeBox__lOdeo)}
              key={currentIndex}
            >
              <div
                className={classNames(
        ...
        <Stack__
          as={"div"}
          hasGap={true}
          className={classNames(projectcss.all, sty.freeBox__fMrQ)}
        >
          <RecycleIcon
            className={classNames(projectcss.all, sty.svg__pByTo)}
            role={"img"}
          />

          <Secure2Icon
            className={classNames(projectcss.all, sty.svg__dQdaD)}
            role={"img"}
          />
        </Stack__>
        <div className={classNames(projectcss.all, sty.freeBox___7BlA6)}>
          <div
            className={classNames(
              projectcss.all,
              projectcss.__wab_text,
