...
import sty from "./PlasmicButton.module.css"; // plasmic-import: 5PPoJ-eUqIWV/css
  ...
  return (
      ...
      className={classNames(
        ...
        sty.root,
        {
          ...
          [sty.rootsize_large_showEndIcon_colors_black]:
            ...
            hasVariant($state, "colors", "black") &&
            hasVariant($state, "size", "large"),
          [sty.rootsize_large_showEndIcon_rounded_colors_black]:
            hasVariant($state, "showEndIcon", "showEndIcon") &&
            hasVariant($state, "colors", "black") &&
            hasVariant($state, "size", "large") &&
            hasVariant($state, "rounded", "rounded"),
    ...
    >
      {(
        ...
        <div
          className={classNames(projectcss.all, sty.freeBox__fKh69, {
            [sty.freeBoxiconOnly__fKh69EPq2]: hasVariant(
              $state,
              "iconOnly",
              "iconOnly"
            ),
            [sty.freeBoxshowEndIcon__fKh694Duqv]: hasVariant(
              $state,
              "showEndIcon",
              "showEndIcon"
            ),
            [sty.freeBoxshowStartIcon__fKh69FmMxg]: hasVariant(
              $state,
              "showStartIcon",
              "showStartIcon"
            ),
            [sty.freeBoxsize_large__fKh690AxH]: hasVariant(
              $state,
              "size",
              "large"
            ),
            [sty.freeBoxsize_small__fKh69VEjn2]: hasVariant(
              $state,
              "size",
              "small"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <MenuIcon
                className={classNames(projectcss.all, sty.svg__ij4Xd)}
                role={"img"}
              />
            ),
      ...
      {(hasVariant($state, "showEndIcon", "showEndIcon") ? true : false) ? (
        <div
          className={classNames(projectcss.all, sty.freeBox___2M7J5, {
            [sty.freeBoxshowEndIcon___2M7J54Duqv]: hasVariant(
              $state,
              "showEndIcon",
              "showEndIcon"
            ),
            [sty.freeBoxsize_small___2M7J5VEjn2]: hasVariant(
              $state,
              "size",
              "small"
            )
        ...
        >
          {(hasVariant($state, "showEndIcon", "showEndIcon") ? true : false)
            ? renderPlasmicSlot({
                defaultContents: (
                  <MenuIcon
                    className={classNames(projectcss.all, sty.svg__mhTQl)}
                    role={"img"}
                  />
                ),
