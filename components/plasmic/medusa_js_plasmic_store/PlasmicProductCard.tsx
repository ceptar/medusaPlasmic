...
import sty from "./PlasmicProductCard.module.css"; // plasmic-import: 7SDVrakTDPfy/css
    ...
    >
      ...
      >
        ...
        {(
          ...
          <div
            className={classNames(projectcss.all, sty.freeBox__p9Iyr, {
              [sty.freeBoxsmall__p9IyryNoxi]: hasVariant(
                $state,
                "small",
                "small"
              )
        ...
        <Stack__
          as={"div"}
          hasGap={true}
          className={classNames(projectcss.all, sty.freeBox___1Anhk, {
            [sty.freeBoxsmall___1AnhkyNoxi]: hasVariant(
              $state,
              "small",
              "small"
            )
        ...
        >
          <div className={classNames(projectcss.all, sty.freeBox__vmR1B)}>
            {renderPlasmicSlot({
              defaultContents: (
            ...
            {renderPlasmicSlot({
              defaultContents: (
                <Rating
                  className={classNames("__wab_instance", sty.rating__wrd6M)}
                />
              ),
          ...
          <Stack__
            as={"div"}
            hasGap={true}
            className={classNames(projectcss.all, sty.freeBox__pEled)}
          >
            {renderPlasmicSlot({
              defaultContents: (
                <React.Fragment>
          ...
          <div className={classNames(projectcss.all, sty.freeBox__qbct3)}>
            {(() => {
              try {
