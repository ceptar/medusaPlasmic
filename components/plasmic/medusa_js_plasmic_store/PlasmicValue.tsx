...
import sty from "./PlasmicValue.module.css"; // plasmic-import: HmKaqKMzC78s/css

import TakeOffIcon from "./icons/PlasmicIcon__TakeOff"; // plasmic-import: pQJfc65gzu9e/icon
...
function PlasmicValue__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div
        className={classNames(projectcss.all, sty.freeBox__mqVJx, {
          [sty.freeBoxcenter__mqVJxcOtE5]: hasVariant(
            $state,
            "center",
            "center"
          ),
          [sty.freeBoxtopBottom__mqVJxIlgQb]: hasVariant(
            $state,
            "topBottom",
            "topBottom"
          )
      ...
      >
        <div className={classNames(projectcss.all, sty.freeBox__oys8)}>
          {renderPlasmicSlot({
            defaultContents: (
              <TakeOffIcon
                className={classNames(projectcss.all, sty.svg__xI407)}
                role={"img"}
              />
            ),
      ...
      <Stack__
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__lRp4Y, {
          [sty.freeBoxcenter__lRp4YcOtE5]: hasVariant(
            $state,
            "center",
            "center"
          ),
          [sty.freeBoxwithButton__lRp4Y1QA]: hasVariant(
            $state,
            "withButton",
            "withButton"
          )
      ...
      {(hasVariant($state, "withButton", "withButton") ? true : false) ? (
        <Stack__
          as={"div"}
          hasGap={true}
          className={classNames(projectcss.all, sty.freeBox__i5Spp, {
            [sty.freeBoxcenter__i5SppcOtE5]: hasVariant(
              $state,
              "center",
              "center"
            ),
            [sty.freeBoxwithButton__i5Spp1QA]: hasVariant(
              $state,
              "withButton",
              "withButton"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <Button
                className={classNames("__wab_instance", sty.button__kR9Bq, {
                  [sty.buttonwithButton__kR9Bq1QA]: hasVariant(
                    $state,
                    "withButton",
                    "withButton"
                  )
                ...
                endIcon={
                  <RightArrowIcon
                    className={classNames(projectcss.all, sty.svg__nbWs5)}
                    role={"img"}
                  />
                }
                rounded={true}
