...
import { ProductBox } from "../../medusa/ProductBox"; // plasmic-import: DWcW7bXgLLty/codeComponent
import Price from "../../Price"; // plasmic-import: WXnshuXKCFFh/component
import Button from "../../Button"; // plasmic-import: 5PPoJ-eUqIWV/component
import Select from "../../Select"; // plasmic-import: IGotvDsrozg7/component
import Select__Option from "../../Select__Option"; // plasmic-import: l19tmW8yuzHU/component
...
import sty from "./PlasmicItem.module.css"; // plasmic-import: J-3Ymf7PWpUm/css

import MenuIcon from "./icons/PlasmicIcon__Menu"; // plasmic-import: fdU6wABrtWAZ/icon
import LikeIcon from "./icons/PlasmicIcon__Like"; // plasmic-import: abTodCGCu2UB/icon
    ...
    <React.Fragment>
      ...
      <div className={projectcss.plasmic_page_wrapper}>
        ...
        >
          ...
          >
            <DataCtxReader__>
              {$ctx => (
                <React.Fragment>
                  <section
                    className={classNames(projectcss.all, sty.section__xNpD7)}
                  >
                    <Stack__
                      as={"div"}
                    ...
                    >
                      ...
                      >
                        ...
                        >
                          <PlasmicImg__
                            alt={""}
                            className={classNames(sty.img__yrFn0)}
                            displayHeight={"auto"}
                            ...
                            src={(() => {
                              try {
                                ...
                                if (
                                  ...
                                  return {
                                    src: "/plasmic/medusa_js_plasmic_store/images/shoe20.png",
                                    fullWidth: 2000,
                                    fullHeight: 2000,
                            ...
                            {(_par =>
                              ...
                              return (
                                ...
                                >
                                  <PlasmicImg__
                                    alt={""}
                                    className={classNames(sty.img__rBRhm)}
                                    displayHeight={"auto"}
                                    displayMaxHeight={"none"}
                                    displayMaxWidth={"none"}
                                    displayMinHeight={"0"}
          ...
          <section className={classNames(projectcss.all, sty.section__bmLq)}>
            <div
            ...
            >
              {renderPlasmicSlot({
                defaultContents: (
                  <div
                    className={classNames(projectcss.all, sty.freeBox__fydf6)}
                  >
                    <div
                      className={classNames(
                        projectcss.all,
                    ...
                    <Button
                      ...
                      endIcon={
                        <RightArrowIcon
                          className={classNames(projectcss.all, sty.svg___5Z5P)}
                          role={"img"}
                        />
                      }
                      showEndIcon={true}
            ...
            >
              <Stack__
                as={"div"}
                hasGap={true}
                className={classNames(projectcss.all, sty.freeBox__gZvVj)}
              >
                <ProductCollection
