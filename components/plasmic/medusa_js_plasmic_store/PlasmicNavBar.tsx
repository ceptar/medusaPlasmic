...
import sty from "./PlasmicNavBar.module.css"; // plasmic-import: -0uusTYYAXza/css

import HomeIcon from "./icons/PlasmicIcon__Home"; // plasmic-import: LUPaMmV1_4gr/icon
import MenuIcon from "./icons/PlasmicIcon__Menu"; // plasmic-import: fdU6wABrtWAZ/icon
import SearchIcon from "./icons/PlasmicIcon__Search"; // plasmic-import: SIIxXzdKjcFU/icon
import SearchsvgIcon from "./icons/PlasmicIcon__Searchsvg"; // plasmic-import: kvrECqiiOezc/icon
import ChecksvgIcon from "./icons/PlasmicIcon__Checksvg"; // plasmic-import: PLdPRZkOyRPf/icon
import ProfileIcon from "./icons/PlasmicIcon__Profile"; // plasmic-import: As-o-0Xd4QE3/icon
import CartIcon from "./icons/PlasmicIcon__Cart"; // plasmic-import: XfbZFh9X2RUW/icon
...
function PlasmicNavBar__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div
        className={classNames(projectcss.all, sty.freeBox___4Gpsn, {
          [sty.freeBoxfilled___4GpsnZwyRt]: hasVariant(
            $state,
            "filled",
            "filled"
          ),
          [sty.freeBoxsearchOpen___4GpsnHCbO1]: hasVariant(
            $state,
            "searchOpen",
            "searchOpen"
          )
      ...
      >
        <Button
          ...
          startIcon={
            <HomeIcon
              className={classNames(projectcss.all, sty.svg__hnHAy)}
              role={"img"}
            />
          }
          submitsForm={true}
        ...
        <Stack__
          as={"div"}
          hasGap={true}
          className={classNames(projectcss.all, sty.freeBox__evMBv, {
            [sty.freeBoxsearchOpen__evMBvHCbO1]: hasVariant(
              $state,
              "searchOpen",
              "searchOpen"
            )
        ...
        >
          {(hasVariant($state, "searchOpen", "searchOpen") ? false : true) ? (
            <Button
              ...
              startIcon={
                <SearchIcon
                  className={classNames(projectcss.all, sty.svg__ntyF2)}
                  role={"img"}
                />
              }
              submitsForm={true}
          ...
          {false ? (
            <Button
              ...
              startIcon={
                <ProfileIcon
                  className={classNames(projectcss.all, sty.svg__vKdb)}
                  role={"img"}
                />
              }
              submitsForm={true}
          ...
          <div className={classNames(projectcss.all, sty.freeBox__oKpI)}>
            <CartProvider
              ...
              <DataCtxReader__>
                {$ctx => (
                  <Button
                    ...
                    startIcon={
                      <CartIcon
                        className={classNames(projectcss.all, sty.svg__tkY77)}
                        role={"img"}
                      />
                    }
                    submitsForm={true}
