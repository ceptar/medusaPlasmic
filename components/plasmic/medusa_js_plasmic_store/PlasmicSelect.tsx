...
import Select__Overlay from "../../Select__Overlay"; // plasmic-import: paWwP3mdegm9/component
import Select__Option from "../../Select__Option"; // plasmic-import: l19tmW8yuzHU/component
import Select__OptionGroup from "../../Select__OptionGroup"; // plasmic-import: ELtuOud_UEaz/component
...
import sty from "./PlasmicSelect.module.css"; // plasmic-import: IGotvDsrozg7/css

import ChevronDownIcon from "./icons/PlasmicIcon__ChevronDown"; // plasmic-import: rVVi1mS-n1ns/icon
import ChevronUpsvgIcon from "./icons/PlasmicIcon__ChevronUpsvg"; // plasmic-import: V-DHIxXcAsSD/icon
    ...
    if (!("children" in props)) {
      props = {
        ...
        children: (
          <React.Fragment>
            <Select__Option
              className={classNames("__wab_instance", sty.option___5Zo3B)}
              value={"value1"}
            >
              {"Option 1"}
            </Select__Option>
            <Select__Option
              className={classNames("__wab_instance", sty.option__jyrIs)}
              value={"value2"}
            >
              {"Option 2"}
            </Select__Option>
