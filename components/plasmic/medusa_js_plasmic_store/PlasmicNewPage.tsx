...
import sty from "./PlasmicNewPage.module.css"; // plasmic-import: lrGZjj9xHMRA/css
      ...
      <div className={projectcss.plasmic_page_wrapper}>
        ...
        >
          ...
          >
            <DataCtxReader__>
              {$ctx => (
                <div className={classNames(projectcss.all, sty.freeBox__qe4C)}>
          ...
          >
            <DataCtxReader__>
              {$ctx => (
                <div
                  className={classNames(projectcss.all, sty.freeBox___9Ay7F)}
                >
                  <ProductTextField
                    className={classNames(
                      "__wab_instance",
                      sty.productTextField___6PT4D
                    )}
                    field={"title"}
                  />
          ...
          >
            <DataCtxReader__>
              {$ctx => (
                <div className={classNames(projectcss.all, sty.freeBox__mZEyD)}>
                  <ProductTextField
                    className={classNames(
                      "__wab_instance",
                      sty.productTextField__qoEYg
                    )}
                    field={"title"}
                  />
